...
assert.match(quickView, /callbacks\.openEditor\(id, \{returnFocusTo\}\)/);
assert.match(quickView, /focusField: target,returnFocusTo/);
assert.match(quickView, /canDisplayPublicCard\(card, source \|\| "direct"\)/);
